...
/*  In this program calculate employee wage by using the class methode and class variables.
 * 
 * @ Dnyandeo Bansode
 * 
 */
public class EmployeeWage {
	...
	public static void calculateEmployeeWage() {
		...
		int countPartTime = 0;
		int countAbsent = 0;
		/* Here is generate random num rs 0 or 1 or 2 .
		 * using switch case calculate monthly employee wage of employees.
		 */
